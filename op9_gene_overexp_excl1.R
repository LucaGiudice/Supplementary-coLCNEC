...
#output
out_op13_path_png="output/op9/op9_overexp_excl1_lcpm.png"
out_op13_path_table="output/op9/op9_overexp_excl1_table.xlsx"
out_op13_path_lcpm="output/op9/op9_overexp_excl1_lcpm.txt"
out_op13_path_rda="output/op9_overexp_excl1_analysis.rda"
...
r_max_scores=rowMaxs(score_df,value = T);names(r_max_scores)=rownames(score_df)
  print(quantile(r_max_scores,probs=c(0.6,0.7,0.8,0.9,1)))
th=9
bol_keep=r_max_scores>=th
  print(sum(bol_keep))
  ...
  colnames(stats_gs)=c("gene","excl1");rownames(stats_gs)=seq(1,nrow(stats_gs))
